...
window.onload=function(){
    ...
    $btnFiltrar.click(function () {
        ...
        $table.bootstrapTable('refreshOptions', {
            showRefresh: true,
            url: "/contabilidad/recuperacionespendientesjson/" + desde + "/" + hasta
        })
    })
    ...
    $generar.click(function () {
      GenerarAsientosRecuperaciones();
      $generar.prop('disabled', true)
    })
};
    
function GenerarAsientosRecuperaciones(){
  // validar que los elementos seleccionados sean del mismo cliente
  // y del mismo tipo de factoring

  var ids = getIdSelections()

  fetchProcesar('/contabilidad/generarasientosrecuperaciones/'+ids,function(){
    MensajeOK("Asientos generados. Revíselos en Contabilidad/Asientos/Registros de asientos")
      url = '/contabilidad/listarecuperacionespendientescontabilizar/';
      location.href=url
