...
window.onload=function(){
    ...
    $btnFiltrar.click(function () {
        ...
        $table.bootstrapTable('refreshOptions', {
            showRefresh: true,
            url: "/contabilidad/protestospendientesjson/" + desde + "/" + hasta
        })
    })
...
function GenerarAsientosProtestos(){
  ...
  fetchProcesar('/contabilidad/generarasientosprotestos/'+ids,function(){
    MensajeOK("Asientos generados. Revíselos en Contabilidad/Asientos/Registros de asientos")
      url = '/contabilidad/listaprotestospendientescontabilizar/';
      location.href=url
