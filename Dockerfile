...
# Regenera estaticos desde /app/static y levanta la app.
CMD ["sh", "-c", "python manage.py collectstatic --noinput --clear && gunicorn factorweb25.wsgi:application --bind 0.0.0.0:3000"]